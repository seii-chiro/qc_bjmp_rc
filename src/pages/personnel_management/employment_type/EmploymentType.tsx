import { getEmployment_Type, deleteEmployment_Type, getUser, getOrganization } from "@/lib/queries"
...
const EmploymentType = () => {
    ...
    return (
        <div className="h-screen mt-5">
            {contextHolder}
            <h1 className="text-3xl font-bold text-[#1E365D]">Employment Type</h1>
