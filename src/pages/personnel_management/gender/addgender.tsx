            ...
            <form onSubmit={handleGenderSubmit}>
                ...
                <div className="flex gap-5 w-full">
                    <div className="flex flex-col gap-2 flex-1 mt-10">
                        <div>
                            <p>Gender:</p>
                            <input type="text" name="gender_option" id="gender_option" onChange={handleInputChange} placeholder="Gender Option" className="w-full h-12 border border-gray-300 rounded-lg px-2" />
                        </div>
                        <div>
                            <p>Description:</p>
