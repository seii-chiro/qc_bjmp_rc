...
const Personnel = () => {
    ...
    const columns: ColumnType<PersonnelForm> = [
        ...
        },
        {
            ...
            sorter: (a: { personnel_reg_no: string; }, b: { personnel_reg_no: any; }) => a.personnel_reg_no.localeCompare(b.personnel_reg_no),
            filters: [
                ...Array.from(
                    new Set(
                ...
                pagination={
                    debouncedSearch
                        ...
                        : (filteredData.length > 0
                            ...
                            : false // Hide pagination if no data after filtering
                        )
                }
                rowKey="id"
            />
