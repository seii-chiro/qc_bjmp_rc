...
const RiskLevel = () => {
  ...
  const [selectRiskLevel, setSelctedRiskLevel] =
    useState<RiskLevelProps | null>(null);
  ...
  const dataSource =
    data?.results?.map((risk_level, index) => ({
      key: index + 1,
      id: risk_level?.id ?? "",
      ...
      organization:
        risk_level?.organization ?? "Bureau of Jail Management and Penology",
    })) || [];
    ...
    <div className="p-4">
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleUpdate}>
          <Form.Item name="risk_value" label="Risk Value">
            <Input />
          </Form.Item>
          <Form.Item name="risk_severity" label="Risk Level">
            <Input />
          </Form.Item>
