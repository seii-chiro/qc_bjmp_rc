...
const Impact = () => {
  ...
  const showDeleteConfirm = (id: number) => {
    Modal.confirm({
      centered: true,
      title: "Are you sure you want to delete this impact?",
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleUpdate}>
          <Form.Item
            ...
            label="Impact Name"
            rules={[
              { required: true, message: "Please input the Impact name" },
            ]}
          >
            <Input />
          </Form.Item>
          ...
          <Form.Item name="impact_level" label="Impact Level">
            <Select
              className="h-[3rem] w-full"
              showSearch
