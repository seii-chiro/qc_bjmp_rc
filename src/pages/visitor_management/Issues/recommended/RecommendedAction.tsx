...
const RecommendedAction = () => {
  ...
  const [selectRecommended, setSelectedRecommended] =
    useState<RecommendedActionProps | null>(null);
  ...
  const showDeleteConfirm = (id: number) => {
    Modal.confirm({
      centered: true,
      title: "Are you sure you want to delete this recommended action?",
  ...
  const dataSource =
    data?.results?.map((recommeded) => ({
      ...
      organization:
        recommeded?.organization ?? "Bureau of Jail Management and Penology",
    ...
    <div>
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleUpdate}>
          <Form.Item
            name="name"
            label="Recommended Action Name"
            rules={[
              {
                required: true,
                message: "Please input the Recommended Action name",
              },
            ]}
          >
            <Input />
