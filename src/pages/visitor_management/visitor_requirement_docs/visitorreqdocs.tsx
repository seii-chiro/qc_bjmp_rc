import { getVisitor_Req_Docs, deleteVisitor_Req_Docs, getUser } from "@/lib/queries"
...
const VisitorReqDocs = () => {
    ...
    const dataSource = data?.map((visitor_req_docs, index) => (
        {
            ...
            organization: visitor_req_docs?.organization ?? 'Bureau of Jail Management and Penology',
    ...
    return (
        <div className="h-screen">
            {contextHolder}
            <h1 className="text-3xl font-bold text-[#1E365D]">Visitor Requirements Documents</h1>
