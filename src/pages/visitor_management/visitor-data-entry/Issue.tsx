  ...
  const columns: ColumnsType<IssueFormData> = [
    ...
    },
    {
      ...
      render: (riskLevelId: number) => {
        const riskLevelObj = riskLevels?.find(
          (r: { id: number }) => r.id === riskLevelId
        );
    ...
    },
    {
      ...
      render: (impactLevelId: number) => {
        const impactLevelObj = impactLevels?.find(
          (r: { id: number }) => r.id === impactLevelId
        );
    ...
    },
    {
      ...
      render: (impactId: number) => {
        const impactObj = impact?.find(
          (r: { id: number }) => r.id === impactId
        );
    ...
    },
    {
      ...
      render: (statusId: number) => {
        const statusObj = issueStatuses?.find(
          (r: { id: number; description: string }) => r.id === statusId
        );
          ...
          <Button
            ...
            onClick={() => {
              Modal.confirm({
                ...
                okType: "danger",
                cancelText: "Cancel",
                onOk: () => deleteIssue(index),
              });
            }} // Call deleteIssue function
          >
            <AiOutlineDelete />
          </Button>
        </div>
