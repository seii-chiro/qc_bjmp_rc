...
const VisitorRegistration = () => {
  ...
  const addVisitorMutation = useMutation({
    ...
    mutationFn: (id: number) =>
      registerVisitor({ ...visitorForm, person_id: id }, token ?? ""),
    onSuccess: () => {
            ...
            <div className="flex gap-2 w-[50%]">
              ...
              <div className="flex flex-col mt-2 w-full">
                ...
                <Select
                  ...
                  options={visitorTypes?.map(
                    (type: { id: any; visitor_type: any }) => ({
                      value: type?.id,
              ...
              <div className="flex flex-col mt-2 w-full">
                ...
                <Select
                  ...
                  options={nationalities
                    ?.map((nationality: { id: any; nationality: any }) => ({
            ...
            <div className="flex flex-col md:flex-row gap-2">
              ...
              <div className="flex flex-col mt-2 flex-1">
                ...
                <Select
                  ...
                  optionFilterProp="label"
                  className="mt-2 h-10 rounded-md outline-gray-300 !bg-gray-100"
                  options={suffixes?.map(
                    (suffix: { id: any; suffix: any }) => ({
                      value: suffix?.id,
                      label: suffix?.suffix,
                    })
                  )}
            ...
            <div className="flex flex-col md:flex-row gap-2">
              ...
              <div className="flex flex-col mt-2 flex-1">
                ...
                <Select
                  ...
                  optionFilterProp="label"
                  className="mt-2 h-10 rounded-md outline-gray-300 !bg-gray-100"
                  options={civilStatuses?.map(
                    (civilStatus: { id: any; status: any }) => ({
              ...
              <div className="flex flex-col mt-2 flex-[2]">
                ...
                <Select
                  ...
                  className="mt-2 h-10 rounded-md outline-gray-300 !bg-gray-100"
                  options={affiliations?.map(
                    (affiliation: { id: any; affiliation_type: any }) => ({
          ...
          <div className="flex flex-col gap-5 w-full">
            ...
            <div className="flex items-center justify-between w-full gap-5">
              <div className="flex flex-col mt-2 w-[18.5%]">
                <div className="flex gap-1">
                  ID No. <p className="text-red-600">*</p>
                </div>
                <Input
              ...
              <div className="flex gap-4 w-[30%] h-full items-end">
                ...
                <Button
                  ...
                  loading={
                    addPersonMutation.isPending || addVisitorMutation.isPending
                  }
