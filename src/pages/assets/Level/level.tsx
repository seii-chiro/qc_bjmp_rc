import {
  deleteDetention_Building,
  getDetention_Building,
  getJail,
  getJail_Security_Level,
  getOrganization,
  getUser,
  updateDetention_Building,
} from "@/lib/queries";
...
const Level = () => {
  ...
  const handleExportPDF = () => {
    ...
    const tableData = (isSearching ? filteredData || [] : dataSource || []).map(
      (item, idx) => [idx + 1, item.bldg_name, item.jail, item.bldg_status]
    );
      ...
      <div className="w-full">
        ...
        >
          <Form form={form} layout="vertical" onFinish={handleUpdate}>
            ...
            <Form.Item label="Jail Security Level" name="security_level">
              <Select
                className="h-[3rem] w-full"
                showSearch
