...
const JailArea = () => {
  ...
  const showDeleteConfirm = (id: number) => {
    Modal.confirm({
      centered: true,
      title: "Are you sure you want to delete this jail area?",
  ...
  const dataSource =
    data?.results?.map((jailarea, index) => ({
      key: index + 1,
      id: jailarea?.id,
  ...
  const handleExportPDF = () => {
    ...
    const addHeader = () => {
      ...
      doc.setFontSize(16);
      doc.text("Jail Area Report", 10, 15);
  ...
  return (
    <div>
      {contextHolder}
      <h1 className="text-3xl font-bold text-[#1E365D]">Jail Area</h1>
