...
const MultiBirth = () => {
  ...
  const [selectMultiBirth, setselectMultiBirth] =
    useState<MultiBirthType | null>(null);
  ...
  const showDeleteConfirm = (id: number) => {
    Modal.confirm({
      centered: true,
      title: "Are you sure you want to delete this birth classification?",
  ...
  const columns: ColumnsType<MultiBirthType> = [
    ...
    },
    {
      ...
      sorter: (a, b) =>
        a.term_for_sibling_group.localeCompare(b.term_for_sibling_group),
    },
    {
      title: "Description",
  ...
  return (
    <div className="h-screen">
      {contextHolder}
      <h1 className="text-[#1E365D] text-3xl font-bold">
        Multi Birth Classification
      </h1>
