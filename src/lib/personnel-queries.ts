import { PersonnelApplicationStatusPayload, PersonnelDesignationPayload } from "./issues-difinitions";
import { BASE_URL } from "./urls";

export async function getPersonnelDesignation(token: string): Promise<PersonnelDesignationPayload> {
...
export const deletePersonnelDesignation = async (token: string, id: number) => {
    const response = await fetch(`${BASE_URL}/api/codes/personnel-designations/${id}/`, {
        method: "DELETE",
        headers: {
        Authorization: `Token ${token}`,
        },
...
export async function getPersonnelStatus(token: string): Promise<PersonnelDesignationPayload> {
...
export const deletePersonnelStatus = async (token: string, id: number) => {
    const response = await fetch(`${BASE_URL}/api/codes/personnel-status/${id}/`, {
        method: "DELETE",
        headers: {
        Authorization: `Token ${token}`,
        },
...
export async function getPersonnelType(token: string): Promise<PersonnelDesignationPayload> {
...
export async function getPersonnelApplicationStatus(token: string): Promise<PersonnelApplicationStatusPayload> {
    const res = await fetch(`${BASE_URL}/api/pdls/personnel-application-statuses/`, {
        headers: {
        "Content-Type": "application/json",
        Authorization: `Token ${token}`,
        },
...
export const deletePersonnelApplicationStatus = async (token: string, id: number) => {
    const response = await fetch(`${BASE_URL}/api/pdls/personnel-application-statuses/${id}/`, {
        method: "DELETE",
        headers: {
        Authorization: `Token ${token}`,
        },
...
export async function getPDLVisitationStatus(token: string): Promise<PersonnelApplicationStatusPayload> {
...
export const deletePDLVisitationStatus = async (token: string, id: number) => {
    const response = await fetch(`${BASE_URL}/api/pdls/pdl-visitation-statuses/${id}/`, {
        method: "DELETE",
        headers: {
        Authorization: `Token ${token}`,
        },
